...
#define __CREATE_ASSERT_ARR_CMP__(__TYPE__,__TEST__, _LHS__,_NLHS__,    \
                                  _RHS__,_NRHS__,_OP_)                  \
  if(!unit_add_assertion((__TEST__),                                    \
...
#define ASSERT_NEQ_ARR_PTR(__TEST__,                                    \
                           __LHS__,__NLHS__,                            \
                           __RHS__,__NRHS__)                            \
  __CREATE_ASSERT_ARR_CMP__(ptr, (__TEST__),                            \
                            (const void**)(__LHS__), (__NLHS__),        \
 ...
 *
 **********************************************************************/
#define ASSERT_EQ_ARR_CSTR(__TEST__,                                    \
                           __LHS__,__NLHS__, __RHS__,__NRHS__)          \
...
#define ASSERT_NEQ_ARR_CSTR(__TEST__,                                   \
                            __LHS__,__NLHS__, __RHS__,__NRHS__)         \
  __CREATE_ASSERT_ARR_CMP__(cstr, (__TEST__),                           \
                            (__LHS__),(__NLHS__),                       \
                            (__RHS__), (__NRHS__),                      \
...
#define CHECK_NEQ_ARR_CSTR(__TEST__,                                    \
                           __LHS__,__NLHS__, __RHS__,__NRHS__)          \
  __CREATE_CHECK_ARR_CMP__(cstr, (__TEST__),                            \
                           (__LHS__),(__NLHS__),                        \
                           (__RHS__), (__NRHS__), "!=")

#define ASSERT_LT_ARR_CSTR(__TEST__,                                    \
                           __LHS__,__NLHS__, __RHS__,__NRHS__)          \
  __CREATE_ASSERT_ARR_CMP__(cstr, (__TEST__),                           \
                            (__LHS__),(__NLHS__),                       \
                            (__RHS__), (__NRHS__),                      \
...
#define CHECK_LT_ARR_CSTR(__TEST__,                                     \
                          __LHS__,__NLHS__, __RHS__,__NRHS__)           \
  __CREATE_CHECK_ARR_CMP__(cstr, (__TEST__),                            \
                           (__LHS__),(__NLHS__),                        \
                           (__RHS__), (__NRHS__), "<")

#define ASSERT_LE_ARR_CSTR(__TEST__,                                    \
                           __LHS__,__NLHS__, __RHS__,__NRHS__)          \
  __CREATE_ASSERT_ARR_CMP__(cstr, (__TEST__),                           \
                            (__LHS__),(__NLHS__),                       \
                            (__RHS__), (__NRHS__),                      \
...
#define CHECK_LE_ARR_CSTR(__TEST__,                                     \
                          __LHS__,__NLHS__, __RHS__,__NRHS__)           \
  __CREATE_CHECK_ARR_CMP__(cstr, (__TEST__),                            \
                           (__LHS__),(__NLHS__),                        \
                           (__RHS__), (__NRHS__), "<=")

#define ASSERT_GT_ARR_CSTR(__TEST__,                                    \
                           __LHS__,__NLHS__, __RHS__,__NRHS__)          \
  __CREATE_ASSERT_ARR_CMP__(cstr, (__TEST__),                           \
                            (__LHS__),(__NLHS__),                       \
                            (__RHS__), (__NRHS__),                      \
...
#define CHECK_GT_ARR_CSTR(__TEST__,                                     \
                          __LHS__,__NLHS__, __RHS__,__NRHS__)           \
  __CREATE_CHECK_ARR_CMP__(cstr, (__TEST__),                            \
                           (__LHS__),(__NLHS__),                        \
                           (__RHS__), (__NRHS__), ">")

#define ASSERT_GE_ARR_CSTR(__TEST__,                                    \
                           __LHS__,__NLHS__, __RHS__,__NRHS__)          \
  __CREATE_ASSERT_ARR_CMP__(cstr, (__TEST__),                           \
                            (__LHS__),(__NLHS__),                       \
                            (__RHS__), (__NRHS__),                      \
...
#define CHECK_GE_ARR_CSTR(__TEST__,                                     \
                          __LHS__,__NLHS__, __RHS__,__NRHS__)           \
  __CREATE_CHECK_ARR_CMP__(cstr, (__TEST__),                            \
                           (__LHS__),(__NLHS__),                        \
                           (__RHS__), (__NRHS__), ">=")
